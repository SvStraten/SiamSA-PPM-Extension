...
from Preprocessing.utils import data_loader_fop, preprocess_fop, check_gpu
...
for i in range(repetitions):
    ...
    os.makedirs("FOPModels", exist_ok=True)
    torch.save(model.state_dict(), f"FOPModels/{dataName}_fop_{i}.pth")
    print("Model saved.")